...
import { year } from '../../../comonFunc/comonFunc';
...
const SectionFive = () => {
  return (
    <div className="flex flex-col">
      <HeaderOne className="flex justify-start items-center gap-2 text-[16px] lg:text-[24px]">
        ...
        <span className="block lg:hidden">
          ...
          >
            ...
            />
            <path
              d="M7.7915 14.2083L14.2082 7.79163"
              stroke="#292D32"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M14.2082 14.2083L7.7915 7.79163"
              stroke="#292D32"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <ParagraphOne className="mb-[28px]">
        This documentation provides a foundational understanding for integrating with the Retouched
        services. For further assistance, please email our technical support team at{' '}
        <span className="text-[#009665] font-bold">info@thekowcompany.com</span>
      </ParagraphOne>

      <p className="text-[#9F9F9F] text-[12px] leading-6 font-anek-latin">
        © {year()} 3D Studio Company Ltd. All rights reserved.
      </p>
    </div>
  );
};
