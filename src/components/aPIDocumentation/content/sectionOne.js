        ...
        <div className="flex flex-col ">
                <div className="flex flex-col gap-[28px]">
                  <div className='flex flex-col gap-[6px]'>
                    <HeaderOne className="">Retouched.</HeaderOne>
                    <ParagraphOne className={"leading-7 "}>
                      Retouchedis an API-driven platform offering
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-7">
                      <li className="font-anek-latin text-[14px] lg:text-base font-normal">
                        ...
                        Retouched enables companies to automate and enhance
                      ...
                      <li className="font-anek-latin text-[14px] lg:text-base font-normal">
                        ...
                        Through Retouched API endpoints, users can:
